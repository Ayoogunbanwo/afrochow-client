      ...
      <main className="flex-col">
        ...
        <section className="py-12 text-orange-900">
          <div className="max-w-2xl px-4 mx-auto text-center">
            ...
            <div className="flex flex-col text-bold space-y-4 md:flex-row md:space-y-0 md:space-x-4">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-grow px-6 py-3 text-bold text-gray-800 rounded-full focus:ring-2 focus:ring-orange-500"
              />
